...
void setup(void) {
  ...
  xTaskCreatePinnedToCore(
    ventilator,    /* Task function. */
    "ventilator",  /* name of task. */
    10000,       /* Stack size of task */
    NULL,        /* parameter of the task */
    1,           /* priority of the task */
    &ventihandle, /* Task handle to keep track of created task */
...
void ventilator(void* pvParameters) {
